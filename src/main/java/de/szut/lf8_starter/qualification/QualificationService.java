...
public class QualificationService {
    ...
    public ResponseEntity<QualificationDto> getQualificationById(long id) {
//        HttpHeaders headers = new HttpHeaders();
//        headers.setBearerAuth(token);
//        HttpEntity<String> entity = new HttpEntity<>(headers);
//        return this.restTemplate.exchange(qualificationUrl + "/{id}", HttpMethod.GET, entity, QualificationDto.class, id);

//        RequestEntity<Void> request = RequestEntity.get(qualificationUrl + "/{id}", id)
//                .accept(MediaType.APPLICATION_JSON)
//                .header("Authorization", token)
//                .build();
//
//        ResponseEntity<QualificationDto> qualificationEntity =
//                restTemplate.exchange(request, QualificationDto.class);
//
//        return qualificationEntity.getBody() != null;
    }
